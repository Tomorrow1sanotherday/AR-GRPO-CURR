...
class GRPOTrainer_M(Trainer):
    ...
    def _get_per_token_logps(self, model, input_ids, attention_mask, logits_to_keep, batch_size=None) -> torch.Tensor:
        ...
        for i in range(0, input_ids.size(0), batch_size):
            ...
            logps = selective_log_softmax(logits, input_ids_batch.to(torch.int64))  # compute logprobs for the input tokens
    ...
    def _generate_and_score_completions(
        ...
        if self.use_vllm:
            ...
            with unwrap_model_for_generation(
                ...
                with (
                    ...
                    res = unwrapped_model.generate(
                        prompt_ids, attention_mask=prompt_mask, generation_config=self.generation_config
                    )
                    #############################################
                    prompt_completion_ids=res.sequences
                    completion_logits=res.logits
                    #############################################
        ...
        #print(prompt_completion_ids.shape,logits_to_keep)
        ...
        self.log_images(completions,prompt_ids[:,0])
    ...
    def _compute_loss(self, model, inputs):
        ...
        entropy=entropy_from_logits(inputs["completion_logits"])
        #per_token_loss -= entropy_coef * entropy.mean()
        #=============================================================================
        ...
        self._metrics[mode]["entropy"].append(entropy.nanmean().item())
        self._metrics[mode]["coef_1"].append(coef_1.nanmean().item())
