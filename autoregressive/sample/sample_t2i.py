...
def main(args):
    ...
    caption_ids, _ = t5_model.text_tokenize(prompts)
    ...
    t1 = time.time()
    print(c_indices.shape)
    index_sample = generate(
        gpt_model, c_indices, latent_size ** 2, 
        c_emb_masks, cond_ids=caption_ids, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--t5-model-type", type=str, default='google/flan-t5-xl')
